// variables
const image_wide = document.querySelectorAll(".image_wide");


image_wide.forEach((elem) => {
    const outer = elem;
    const inner = elem.querySelector('.image_with_render');
...
`;
    ...
    initializeScene(new THREE.TextureLoader().load(inner.src));
